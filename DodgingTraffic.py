...
score_increment_period = {0: 60, 1: 30, 2: 10, 3: 690} # Increase score every x frames
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                elif event.key == K_SPACE or event.key == K_c:  # Select key with SPACE or C
