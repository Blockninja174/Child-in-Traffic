...
def get_input():
    if joystick:
        return get_input_with_onscreen_keyboard()
    else:
        return get_input_with_keyboard()

def get_input_with_onscreen_keyboard():
    keys_layout = [
        "1 2 3 4 5 6 7 8 9 0",
        "Q W E R T Y U I O P",
        "A S D F G H J K L",
    ...
    while True:
        ...
        draw_text(win, "Enter your name and then press B:", (30, 30, 30), 32, width // 2, height // 6)
...
while running:
    ...
    if game_over:
        ...
        # Detects which keys are pressed, uses this to normalise movement vectors
